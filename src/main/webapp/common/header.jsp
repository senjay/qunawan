			...
			<ul class="top_link">
				...
				<li id="person" class="dropdown"><a rel="nofollow"
					...
					<div class="personlist">
						<ul class="p_ul">
							<li><a
								href="${pageContext.request.contextPath }/personal/myOrder">我的订单</a></li>
							<li><a
								href="${pageContext.request.contextPath }/personal/personalinf">个人资料</a></li>
							<li><a
								href="${pageContext.request.contextPath }/personal/updatepwd">修改密码</a></li>
							<li><a
								href="${pageContext.request.contextPath }/personal/myContacts">常用游客</a></li>
						</ul>
					</div></li>
			...
			<div class="topbar_login">
				...
				<div>
					...
					<c:choose>
            		 ...
            		 | 		<a
								href="${pageContext.request.contextPath }/">免费注册</a>
						</c:when>
						<c:otherwise>
            				当前用户：
	            			<c:choose>
