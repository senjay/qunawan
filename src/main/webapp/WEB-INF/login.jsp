	...
	<div class="backgrounds" id="backgrounds">
		...
		<div class="content" id="div_position">
			...
			<div class="login_framework">
				...
				<form id="log_reg_form" method="post" name="loginForm" action="${pageContext.request.contextPath }/<%=response.encodeURL("user/login")%>">
				
					<div class="content2">
						<div id="contents" class="contents">${err_msg}</div>
						<ul>
							<li><input id="tid" name="phone" type="text" class="text"
						...
						<ul id="identfy_all">
							<li>
								<span class="identifying">
									...
									<img src="${pageContext.request.contextPath }/<%=response.encodeURL("user/code")%>" width="120px" height="40px"
									onclick="javascript:this.src='${pageContext.request.contextPath }/<%=response.encodeURL("user/code")%>?id='+new Date().getMilliseconds()">
