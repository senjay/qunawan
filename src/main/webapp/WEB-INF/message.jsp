<%@page import="com.finalwork.qunawan.globle.Constants"%>
...
<body>
	...
	<div style="font-family:Microsoft YaHei">
		...
		<%=s %>
		<br/>
		<a href="${pageContext.request.contextPath }/WEB-INF/jsp/login.jspsp/login.jsp" style="text-decoration:none">&lt;&lt; 点击此出返回登录页</a>
	</div>
</body>
</html>