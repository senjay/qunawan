...
<%--	<div style="display: none" id="price_data">${my:getPriceData(detail.price_list)}</div>--%>
	...
	<div style="display: none" id="location">${detail.positionObject.p1},${detail.positionObject.p2},${detail.positionObject.level}</div>
	<!-- 隐藏域，用于存储用户id -->
		...
		<div class="body_bg" style="padding-bottom: 30px;">
			...
			<div class="navigation">
				<span class="font_trip_title"> <a
					...
					href="search.jhtml?triptype=${detail.seqType.value}">${detail.seqType.value}</a>
																...
																<div class="left">
																	<ul>
																		...
																		<li class="clearfix bus">
																			...
																			<div>
																				<p title="管家加州派酒店（地址：成都市金牛区二环路北一段14号）">上车点：${detail.schedule.trafficObject.goPoint }</p>
																				<p>
																					发车时间：<span class="bus-time">${detail.schedule.trafficObject.goTime }</span>
																				</p>
																			</div>
																		</li>
																	</ul>
																...
																<div class="left">
																	<ul>
																		<li class="clearfix bus">
																			...
																			<div>
																				<p title="九寨沟沟口">上车点：${detail.schedule.trafficObject.returnPoint }</p>
																				<p>
																					发车时间：<span class="bus-time">${detail.schedule.trafficObject.returnTime }</span>
																				</p>
																			</div>
																		</li>
																	</ul>
