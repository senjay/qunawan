		...
		<div class="top10">
			...
			<div class="main_l">
				...
				<c:forEach items="${t_list }" var="trip" varStatus="n">
					<div class="recommend">
						<div class="detail"> 
							<a class="detail_img" href="tripDetail?id=${trip.id}&type=init">
								<img src="image_cache/${trip.main_picname }" width="195" height="130" />
								<c:if test="${fn:trim(trip.seqType.value) == '自驾游' }">
									<span class="detail_tag detail_tag_blue">自驾游</span>
								</c:if>
								<c:if test="${fn:trim(trip.seqType.value) == '国内游' }">
									<span class="detail_tag detail_tag_green">国内游</span>
								</c:if>
								<c:if test="${fn:trim(trip.seqType.value) == '出境游' }">
							...
							<div class="detail">
								<div class="detail_list">
									<p class="detail_title">
										...
										<a href="tripDetail?id=${trip.id}&type=init">
											${fn:trim(trip.title) }
										</a>
									</p>	
