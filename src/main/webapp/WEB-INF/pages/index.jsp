...
<body>
								...
								<li>
									<div class="pro_list_content">
										<p>
											...
											<a href="<%=response.encodeURL("tripDetail")%>?id=${item.id}&type=init" title="###" target="_blank"><img
	...
	<div id="nav-right" class="nav-right">
		<div class="nav-right-nav">
			<ul class="clearfix">
				<a id="nav1" href="javascript:void(0)">
					<li id="dd"><h3>顶端</h3></li> </a>
				<a id="nav2" href="javascript:void(0)">
					<li id="zj"><h3>自驾</h3></li>
				</a>
				<a id="nav3" href="javascript:void(0)">
					<li id="gn"><h3>国内</h3></li>
				</a>
				<a id="nav4" href="javascript:void(0)">
