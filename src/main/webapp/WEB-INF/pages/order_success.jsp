			...
			<div class="panel3">
				<div class="order_box success_box" style="display: block" id="paysuccess">
					...
					<div class="suc_info">
						...
						<span class="green_font"><b>共计 ￥${vo.order.totalPrice }元</b></span>
					</div>
					<div class="dot_line"></div>
					<div class="order_info">
						<p>
							<span class="number">订单号：<b>${vo.order.orderno }</b></span>
							<span class="name">订单名称：${vo.order.content }</span>
							<span class="prices">在线支付：￥${vo.order.totalPrice }元</span>
						</p>
					</div>
					<div class="dot_line"></div>
					<div class="order_end">
						<div class="returnIndex"></div>
						<span><a href="myorder?type=initOrderDetail&order_id=${vo.order.id }">查看订单详情 >></a></span>
					</div>
				</div>
			</div>
			<!-- 预订成功【结束】 -->
